...
###############################################################################
# Copied from https://github.com/mathiasbynens/dotfiles/blob/master/.macos#L415
# and slightly modified.
###############################################################################

function log() {
    local msg="$1"
    echo "[bootstrap][darwin][settings] ${msg}"
}

log "Preparing to update..."
...
# Configure text auto correction/completion/substitution.
...
# Disable "minimize on double-click"
...
# Position Dock on the bottom of the screen
